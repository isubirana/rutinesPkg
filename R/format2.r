#' format2
#' similar a format però posa el digits per defecte de forma 'intel.ligent'.
#' @param x vector numèric
#' @param digits nombre de decimals

#' @export
format2<-function(x,digits=NULL,...){
  ...
  if (!is.null(digits)){
    ...
    return(ifelse(x<10,format(round(x,2),trim=TRUE,nsmall=2,...),
